...
<<<<<<<< Updated upstream:Above_backend/Above_backend/Migrations/20250404100221_Init.cs
                    CharacterArtPath = table.Column<string>(type: "TEXT", nullable: true),
========
                    SpellSheet = table.Column<string>(type: "TEXT", nullable: false),
>>>>>>>> Stashed changes:Above_backend/Above_backend/Migrations/20250423120913_Init.cs
                    UserId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
